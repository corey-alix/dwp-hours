...
export function extractPreviousYearsCarryOverPTO(sheetData: JsonSheet): number {
  ...
  if (
    carryOverCell &&
    carryOverCell.value !== undefined &&
    carryOverCell.value !== null &&
    carryOverCell.value !== ""
  ) {
    if (typeof carryOverCell.value === "number") {
      return carryOverCell.value;
    } else if (
      typeof carryOverCell.value === "object" &&
      carryOverCell.value &&
      "result" in carryOverCell.value &&
      typeof carryOverCell.value.result === "number"
    ) {
  ...
  if (v42Cell && v42Cell.value !== undefined) {
    if (typeof v42Cell.value === "number") {
      ...
      typeof v42Cell.value === "object" &&
      v42Cell.value &&
      "result" in v42Cell.value &&
      typeof v42Cell.value.result === "number"
    ) {
  ...
  if (o42Cell && o42Cell.value !== undefined) {
    if (typeof o42Cell.value === "number") {
      ...
      typeof o42Cell.value === "object" &&
      o42Cell.value &&
      "result" in o42Cell.value &&
      typeof o42Cell.value.result === "number"
    ) {
...
export function extractSickHoursStatus(
  sheetData: JsonSheet,
  ...
  if (typeof allowedCell.value === "number") {
    ...
    typeof allowedCell.value === "object" &&
    allowedCell.value &&
    "result" in allowedCell.value &&
    typeof allowedCell.value.result === "number"
  ) {
  ...
  if (usedCell) {
    if (typeof usedCell.value === "number") {
      ...
      typeof usedCell.value === "object" &&
      usedCell.value &&
      "result" in usedCell.value &&
      typeof usedCell.value.result === "number"
    ) {
  ...
  if (remainingCell) {
    if (typeof remainingCell.value === "number") {
      ...
      typeof remainingCell.value === "object" &&
      remainingCell.value &&
      "result" in remainingCell.value &&
      typeof remainingCell.value.result === "number"
    ) {
...
export function extractMonthCellRange(
  sheetData: JsonSheet,
  monthName: string,
): string | null {
