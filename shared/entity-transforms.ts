...
export function serializeMonthlyHours(entity: EntityMonthlyHours): MonthlyHours {
    return {
        id: entity.id,
        employeeId: entity.employee_id,
        month: entity.month,
...
export function serializeAcknowledgement(entity: EntityAcknowledgement): Acknowledgement {
    return {
        id: entity.id,
        employeeId: entity.employee_id,
        month: entity.month,
...
export function serializeAdminAcknowledgement(entity: EntityAdminAcknowledgement): AdminAcknowledgement {
    return {
        id: entity.id,
        employeeId: entity.employee_id,
        month: entity.month,
