...
export function playground() {
  ...
  addEventListener(employeeForm, "employee-submit", (e: CustomEvent) => {
    ...
    querySingle("#test-output").textContent =
      `Form submitted: ${e.detail.isEdit ? "Edit" : "Add"} - ${e.detail.employee.name}`;
  });
  ...
  // Test edit mode - commented out for E2E compatibility
  // setTimeout(() => {
  ...
  // Test add mode - commented out for E2E compatibility
  // setTimeout(() => {
