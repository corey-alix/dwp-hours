...
test.describe("Main Test Page", () => {
  test("should complete automated TestWorkflow successfully", async ({
    page,
  }) => {
    ...
    await Promise.race([
      page.waitForSelector(
        '#test-output:has-text("All workflow steps completed successfully")',
        { timeout: 25000 },
      ),
      page.waitForSelector(
        '#test-output:has-text("Test failed to initialize")',
        { timeout: 25000 },
      ),
