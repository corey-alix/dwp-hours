...
7. **No year navigation** — ~~The page shows only `getCurrentYear() - 1`. There's no year selector to view PTO history for 2024, 2023, etc.~~ **Addressed** by `TASKS/prior-year-navigation.md`: the page now has a prev/next year navigation bar driven by `GET /api/pto/available-years`.
